    ...
    const renderTransactionDetails = (
        <div className="transaction-history">
           ...
           <tr>
                    <td>0.1</td>
                    <td>DAI</td>
                    <td><span>0xDD4c48C0B24031.....</span><img src={copy} alt="copy" /></td>
        ...
        <div className="resources">
            ...
            <ul>
                {lists.map((list,index) => {
                    return (
                        <li key={index} className="txt-reg-14-txt-sec">{list}</li>
                    )
                })}
            </ul>
            ...
            <ul>
                {queries.map((query,index) => {
                    return (
                        <li key={index} className="txt-reg-14-txt-sec">{query}</li>
                    )
                })}
            </ul>
        </div>
